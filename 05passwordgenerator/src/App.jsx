      ...
      <div className='w-full max-w-xl mx-auto shadow-md 
       rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          <input 
          className='outline-none w-full py-3 px-4 text-xl '
          type="text"
          value={password}
          ...
          className='outline-none bg-blue-500 hover:bg-blue-700 text-white
        ...
        <div className='flex text-sm gap-x-2'>
          ...
          <div className='flex items-center gap-x-1 text-xl ml-3'>
            <input 
            type="checkbox" 
